...
import { useAddStudentsModal } from "../../modals/AddStudentsModal";
...
const StudentList = () => {
    ...
    const showAddStudentsModal = useAddStudentsModal();
...
const getClassNames = ({ isOver, dndState }: { isOver: boolean, dndState: DndState }) => (
    `relative flex items-center px-2 -mt-2 w-[calc(100%-10rem)] rounded-lg border-2 border-transparent hover:border-border min-h-14
